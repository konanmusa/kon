...
g= datetime.datetime(2023, 11, 30, 0,  0, 0)
...
#		pwpluss.append('no')
	...
	cetak(panel(f'[bold white]بدك تضيف يوزر اجينت? Y/T',width=79,title=f"[bold green]اعدادات يوزر اجينت",style="bold hot_pink2")) 
...
def passwrd():
	...
	print(f'\n\t\t\t{P}كل ماتفحص ميتين ايدي حط وضع طيران وشيلو {M}{P}')
